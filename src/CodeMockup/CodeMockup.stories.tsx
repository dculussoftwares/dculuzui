...
Default.args = {
  children: <CodeMockup.Line>yarn add daisyui react-dculus-daisyui</CodeMockup.Line>,
}
...
LinePrefix.args = {
  children: (
    <CodeMockup.Line dataPrefix="$">
      yarn add daisyui react-dculus-daisyui
    </CodeMockup.Line>
  ),
}
...
MultiLine.args = {
  children: [
    <CodeMockup.Line>yarn add daisyui react-dculus-daisyui</CodeMockup.Line>,
